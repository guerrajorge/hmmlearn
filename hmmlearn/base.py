...
class _BaseHMM(BaseEstimator):
    ...
    def fit(self, X, logger, kmeans_opt, lengths=None):
        ...
        """
        # X = check_array(X)
        self._init(X, logger, kmeans_opt, lengths=lengths)
        self._check()
        ...
        logger.getLogger('tab.regular.time').info('finished hmm calculations')
        return self
